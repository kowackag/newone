...
const Parameters = (props) => {
    ...
    return( 
        <StyledParameters>
            ...
            <Input className="form__value" type="number" unit="kg" name="weight" value={weight} onChange={props.onChange} err={errWeight ? true : false}/>
            {errWeight && <p className="errors">{errWeight}</p>}
            <Label>Wzrost</Label> 
            <Input className="form__value" type="number" unit="cm" name="height" value={height} onChange={props.onChange} err={errHeight ? true : false}/>
            {errHeight && <p className="errors">{errHeight}</p>}
            <Label>Data urodzenia</Label> 
            <Input className="form__value" type="date" name="born" value={born} onChange={props.onChange} err={errBorn ? true : false}/>
